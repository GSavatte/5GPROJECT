...
docker compose -f compose-files/docker-compose.gnbs.yaml down
docker compose -f compose-files/docker-compose.loadtest.yaml down
docker compose -f compose-files/docker-compose.monitoring.yaml down
